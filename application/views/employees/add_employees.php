                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group string required">
                                                            <label class="string required control-label" for="employee_new_password">New Password</label>
                                                            <div class="form-group string required employee_new_password">
                                                               <!--<span class="input-group-addon">%</span>-->
                                                                <input class="password required form-control" placeholder="" type="password" name="employee[new_password]" id="employee_new_password" required="required" value="<?php echo $staffpassword['password'] ?>" maxlength="15">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group string required">
                                                            <label class="string required control-label" for="employee_confirm_password">Confirm Password</label>
                                                            <div class="form-group string required employee_confirm_password">
                                                               <!--<span class="input-group-addon">%</span>-->
                                                                <input class="password required form-control" placeholder="" type="password" name="employee[confirm_password]" id="employee_confirm_password" required="required" value="<?php echo $staffpassword['password'] ?>" maxlength="15">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
