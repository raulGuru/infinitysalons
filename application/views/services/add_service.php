                                ...
                                <div class="row m-t-20">
                                    ...
                                    <div class="col-md-8 right-modal-column-md">
                                        ...
                                        <div class="form-group m-t-20 text optional service_description">
                                            ...
                                            <textarea rows="5" class="text optional form-control" placeholder="e.g. the world's most spectacular service" name="service[description]" id="service_description"></textarea>
                                        </div>
                                        <!--</div>-->
                                    </div>
                                </div>
