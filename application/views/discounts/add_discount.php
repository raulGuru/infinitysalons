            ...
            <div class="new-form">
               <form class="simple_form new_discount" id="new_discount">
                  ...
                  <div class="modal-body sm-padding-10 p-t-none">
                     ...
                     <div class="form-group string required discount_name"><label class="string required control-label" for="discount_name"><abbr title="required">*</abbr> Discount Name</label><input class="string required form-control" autofocus="autofocus" placeholder="e.g. Senior Citizens" type="text" name="discount[name]" id="discount_name" required="required"></div>
                     <div class="row">
                        <div class="col-sm-6">
