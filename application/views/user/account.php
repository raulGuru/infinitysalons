    ...
    <div class="bg-white full-height">
        <div class="panel panel-transparent">
            <div class="panel-body sm-padding-20" id="edit_account">
                <form novalidate="novalidate" class="simple_form edit_employee" id="edit_employee" action="/saveaccount" accept-charset="UTF-8" method="post">
                    <input type="hidden" name="id" id="employee_id" value="<?php echo (isset($user) ? $user[0]['id'] : ''); ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group string required employee_first_name">
                                                ...
                                                <input class="string required form-control" autofocus="autofocus" placeholder="e.g. Jane" type="text" value="<?php echo (isset($user) ? $user[0]['first_name'] : ''); ?>" name="first_name" id="employee_first_name">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group string required employee_last_name"> <label class="string required control-label" for="employee_last_name"><abbr title="required">*</abbr> Last Name</label><input class="string required form-control" placeholder="e.g. Doe" type="text" value="<?php echo (isset($user) ? $user[0]['last_name'] : ''); ?>" name="last_name" id="employee_last_name"></div>
                                        </div>
                                    </div>
                                    <div class="form-group string optional employee_mobile_number"><label class="string optional control-label" for="employee_mobile_number">Mobile Number</label><input class="string optional tel-input form-control" data-default-country="in" pattern="\d*" type="text" name="mobile" id="employee_mobile_number" placeholder="+91 91234 56789" value="<?php echo (isset($user) ? $user[0]['mobile'] : ''); ?>"></div></div>
                                    <div class="form-group email required employee_email"><label class="email required control-label" for="employee_email"><abbr title="required">*</abbr> Email</label><input class="string email required form-control" placeholder="mail@example.com" type="email" value="<?php echo (isset($user) ? $user[0]['email'] : ''); ?>" name="email" id="employee_email" readonly="true"></div>
                            </div>
                            <div id="password">
    ...
    $(function () {
        $(".btn-success").click(function () {
            ...
            if (currentPassword == '') {
                ...
                return false;
            } else if (currentPassword != "<?php echo $user[0]['password'] ?>") {
